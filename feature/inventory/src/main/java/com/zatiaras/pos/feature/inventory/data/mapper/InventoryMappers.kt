...
fun Category.toEntity(isSynced: Boolean = false): CategoryEntity = CategoryEntity(
    id = id,
    name = name,
    icon = icon,
    sortOrder = sortOrder,
...
fun ProductEntity.toDomain(category: Category? = null): Product = Product(
    id = id,
    name = name,
    price = price,
    category = category,
...
fun Product.toEntity(isSynced: Boolean = false): ProductEntity = ProductEntity(
    id = id,
    name = name,
    price = price,
...
fun AddOnEntity.toDomain(): AddOn = AddOn(
    id = id,
    name = name,
    price = price,
    isActive = isActive,
...
fun AddOn.toEntity(isSynced: Boolean = false): AddOnEntity = AddOnEntity(
    id = id,
    name = name,
    price = price,
    isActive = isActive,
