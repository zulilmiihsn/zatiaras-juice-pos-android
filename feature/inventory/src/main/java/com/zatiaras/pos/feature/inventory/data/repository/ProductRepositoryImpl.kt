...
class ProductRepositoryImpl @Inject constructor(
    ...
    override fun getProductsByCategory(categoryId: String): Flow<List<Product>> = combine(
    ...
    override fun getProductsByCategoryPaged(categoryId: String): Flow<PagingData<Product>> = Pager(
        config = pagingConfig,
    ...
    override fun searchProductsPaged(query: String): Flow<PagingData<Product>> = Pager(
        config = pagingConfig,
    ...
    override fun getProductCount(): Flow<Int> = productDao.getActiveProductCount()
    ...
    override fun getCategories(): Flow<List<Category>> = categoryDao.getAll().map { entities ->
    ...
    override suspend fun updateCategory(id: String, name: String, icon: String?): Result<Category> = try {
    ...
    override suspend fun assignProductsToCategory(categoryId: String, productIds: List<String>): Result<Unit> = try {
     ...
     */
    override suspend fun syncFromRemote(): Result<Unit> = try {
