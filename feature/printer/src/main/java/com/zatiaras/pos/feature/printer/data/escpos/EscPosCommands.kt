...
object EscPosCommands {
     ...
     */
    fun separator(charCount: Int = 32): ByteArray = "-".repeat(charCount).toByteArray(Charsets.UTF_8) + LINE_FEED

    /**
     * Create a double separator line (equals).
     */
    fun doubleSeparator(charCount: Int = 32): ByteArray = "=".repeat(charCount).toByteArray(Charsets.UTF_8) + LINE_FEED
}
