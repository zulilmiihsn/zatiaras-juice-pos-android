...
import com.zatiaras.pos.core.domain.printing.ReceiptItem
...
class ReceiptViewModel @Inject constructor(
    private val printerHelper: ReceiptPrinter,
    ...
    fun printReceipt() {
        ...
        viewModelScope.launch {
            ...
            printerHelper.printReceipt(transaction.toReceipt()).fold(
                onSuccess = {
...
fun Transaction.toReceipt(): Receipt = Receipt(
    id = id,
