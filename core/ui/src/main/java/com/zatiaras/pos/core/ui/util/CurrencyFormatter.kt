...
object CurrencyFormatter {
     ...
     */
    fun formatCurrency(amount: Double, includeSymbol: Boolean = true, addSpace: Boolean = true): String = formatCurrency(amount.toLong(), includeSymbol, addSpace)
     ...
     */
    fun formatCurrency(amount: Int, includeSymbol: Boolean = true, addSpace: Boolean = true): String = formatCurrency(amount.toLong(), includeSymbol, addSpace)
     ...
     */
    fun formatNumber(amount: Long): String = numberFormat.format(amount)
     ...
     */
    fun getCurrencyFormatter(): NumberFormat = NumberFormat.getCurrencyInstance(indonesiaLocale).apply {
     ...
     */
    fun getNumberFormatter(): NumberFormat = NumberFormat.getNumberInstance(indonesiaLocale)
}

/**
 * Extension function to format Long as Rupiah currency.
 */
fun Long.toRupiah(includeSymbol: Boolean = true): String = CurrencyFormatter.formatCurrency(this, includeSymbol)

/**
 * Extension function to format Int as Rupiah currency.
 */
fun Int.toRupiah(includeSymbol: Boolean = true): String = CurrencyFormatter.formatCurrency(this.toLong(), includeSymbol)

/**
 * Extension function to format Double as Rupiah currency.
 */
fun Double.toRupiah(includeSymbol: Boolean = true): String = CurrencyFormatter.formatCurrency(this.toLong(), includeSymbol)

/**
 * Extension function to format Long with thousands separator (no currency symbol).
 */
fun Long.toFormattedNumber(): String = CurrencyFormatter.formatNumber(this)
