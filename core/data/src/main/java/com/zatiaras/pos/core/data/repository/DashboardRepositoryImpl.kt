...
class DashboardRepositoryImpl @Inject constructor(
    ...
    override suspend fun getTodayRevenue(): Result<Long> = try {
    ...
    override suspend fun getTodayTransactionCount(): Result<Int> = try {
        val (start, end) = todayRange()
    ...
    override suspend fun getTodayItemsSold(): Result<Int> = try {
        val (start, end) = todayRange()
