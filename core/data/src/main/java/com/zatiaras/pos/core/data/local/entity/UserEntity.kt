...
data class UserEntity(
    ...
    companion object {
         ...
         */
        fun hashPassword(password: String): String = PasswordHasher.hash(password)

        /**
         * Verify password against stored hash.
         * Supports both PBKDF2 and legacy SHA-256 formats.
         */
        fun verifyPassword(password: String, hash: String): Boolean = PasswordHasher.verify(password, hash)

        /**
         * Check if password hash needs upgrading to new format.
         */
        fun needsRehash(hash: String): Boolean = PasswordHasher.needsRehash(hash)
    }
}
